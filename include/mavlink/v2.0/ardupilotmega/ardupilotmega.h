, 203, 220, 25, 226, 46, 29, 223, 85, 6, 229, 203, 1, 195, 109, 168, 181, 47, 72, 131, 127, 0, 103, 154, 178, 200, 134, 219, 208, 188, 84, 22, 19, 21, 134, 222, 78, 68, 189, 127, 154, 21, 21, 144, 1, 234, 73, 181, 22, 83, 167, 138, 234, 240, 47, 189, 52, 174, 229, 85, 159, 186, 72, 205, 143, 249, 136, 92, 36, 71, 98, 35, 33, 156, 184, 214, 134, 205, 251, 136, 149, 242, 194, 173, 91, 210, 5, 38, 166, 127, 69, 101, 50, 181, 247, 205, 18, 103, 225, 214, 91, 104, 207, 0, 165, 253, 163, 105, 151, 35, 120, 247, 125, 22, 183, 47, 78, 90, 104, 85, 95, 130, 184, 81, 8, 204, 49, 170, 44, 83, 46, 0}
#endif
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_CONDITION_GLIDE_SLOPE=116, /* Delay mission state machine until within desired glide slope to next point |Glide slope ratio| Empty| Empty| Empty| Landing Latitude| Landing Longitude| Empty|  */
   MAV_CMD_CONDITION_LAST=159, /* NOP - This command is only used to mark the upper limit of the CONDITION commands in the enumeration |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_CONDITION_ROTATE=161, /*  S. Arnold - added for rotating from left to right  |State of motion| Direction of rotation| Empty| Empty| Empty| Empty| Empty|  */
   ...
   MAV_CMD_NAV_SECURITY_WP=600, /* Navigation command contaning a security wp with payload command encoded as pan tilt roll || | | | Vehicle Latitude| Vehicle Longitude| Vehicle Altitude|  */
   MAV_CMD_DO_SECURITY_PYLD_CFOV=601, /* Command a payload using a Center Field of view latitude longitude and altitude |Camera| Zoom| Filter| Empty| CFOV lat| CFOV lng| CFOV alt|  */
   MAV_CMD_DO_SECURITY_PYLD_RPT=602, /* Command a payload using using roll pan tilt values |Camera| Zoom| Filter| Empty| Roll| Pan| Tilt|  */
   MAV_CMD_SAVE_SECURITY_WP=603, /* Request apm to save a security wp continint all info regarding its current state || |  */
   MAV_CMD_SET_SECURITY_WP=604, /* Command a security wp and set mode to security |1: Request flight information| |  */
   MAV_CMD_CLEAR_SECURITY_WP=605, /* Clear a single security point or all security points || |  */
   MAV_CMD_DO_SET_FLIR_COLOR=606, /* Set the Flir Camera Color Mode |Empty| Empty| Empty| Empty| Sent color mode of integer 1 through 10| Empty| Empty|  */
